...
from yeelight.flows import random_loop, disco, lsd

# Replace with your bulb's IP address
bulb = Bulb("172.16.255.94")
# bulb = Bulb("10.72.61.149")
...
# bulb.set_color_temp(4000)  # neutral white
...
# flow = random_loop(duration=750, brightness=100, count=9)
