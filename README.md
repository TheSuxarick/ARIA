...
[![ARIA demo - play on YouTube](https://img.youtube.com/vi/hxsG55GqyB8/maxresdefault.jpg)](https://www.youtube.com/watch?v=hxsG55GqyB8)

[![Watch on YouTube](https://img.shields.io/badge/YouTube-Watch%20demo-FF0000?style=for-the-badge&logo=youtube&logoColor=white)](https://www.youtube.com/watch?v=hxsG55GqyB8)

**[ARIA - demo (YouTube)](https://www.youtube.com/watch?v=hxsG55GqyB8)** - assembled hardware, peripherals, and the web dashboard in use.
...
| `Device/esp32-cam_connection_sheme.png`, `Device/esp-32-wroom_connection_scheme.png` | **Wiring diagrams** - camera board and audio bridge (GPIO ↔ modules, power) |
...
**Figures for the thesis / docs** (place next to `Diploma.tex` in Overleaf or set `\graphicspath`). **Connection diagrams** also live under `Device/` for builders:

- `sdu_logo.png`
- `Device/esp32-cam_connection_sheme.png` - ESP32-CAM wiring
- `Device/esp-32-wroom_connection_scheme.png` - ESP32-WROOM (INMP441 + MAX98357) wiring
...
- Pin and power hookups: see **`Device/esp32-cam_connection_sheme.png`** and **`Device/esp-32-wroom_connection_scheme.png`** (same files as in the repo table above).
